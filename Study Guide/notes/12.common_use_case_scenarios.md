...
* Performance efficiency means getting the performance you desire without overprovisioning
  capacity, but also without sacrificing reliability.
...
*For instance, you may have a web application running in
  ...
  between themselves and your application.
