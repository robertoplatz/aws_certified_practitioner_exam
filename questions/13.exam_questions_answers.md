...
390.  Which Amazon Web Services feature assists in identifying harmful or illegal activity in AWS accounts and workloads?
      ...
      C. Amazon GuardDuty
      D. Amazon CloudWatch
391.  Which AWS service or functionality provides technical support to users who subscribe to the AWS Basic Support plan?a.AWS senior support engineers
      A. AWS technical account manager (TAM)
      B. AWS Trusted Advisor
      C. AWS Discussion Forums
...
392. B. AWS Global Accelerator and Amazon CloudFront are separate services that use the AWS global network and its edge locations around the world.
